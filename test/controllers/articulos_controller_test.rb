...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { comprobar: @articulo.comprobar, contenido: @articulo.contenido, nombre: @articulo.nombre, titulo: @articulo.titulo } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { comprobar: @articulo.comprobar, contenido: @articulo.contenido, nombre: @articulo.nombre, titulo: @articulo.titulo } }
